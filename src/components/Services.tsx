  ...
  const services = [
    {
      ...
      image: "/services/crm_lead_management.png"
    },
    {
      icon: Server,
      ...
      image: "/services/api_integrations.png"
    },
    {
      icon: MessageSquare,
      ...
      image: "/services/whatsapp_automation.png"
    },
    {
      icon: CreditCard,
      ...
      image: "/services/fintech_web_apps.png"
    },
    {
      icon: Megaphone,
    ...
    },
    {
      ...
      image: "/services/website_development.png"
    },
    {
      icon: Workflow,
    ...
    },
    {
      ...
      image: "/services/custom_gen_ai.png"
    },
    {
      icon: MessageSquare,
      ...
      image: "/services/rag_chatbots.png"
    },
    {
      icon: TrendingUp,
      ...
      image: "/services/business_strategy.png"
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-7xl mx-auto mb-16">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative rounded-2xl border border-border bg-card/30 backdrop-blur-sm hover:bg-card/50 transition-all duration-500 hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 cursor-pointer animate-fade-in overflow-hidden flex flex-col"
              ...
              >
                ...
                <div className="relative w-full">
                  ...
                  <div className="absolute bottom-0 left-0 z-20 px-4 md:px-6 w-full translate-y-1/2">
                    <div className="inline-flex p-2.5 md:p-3 rounded-xl bg-background/80 backdrop-blur-md border border-border group-hover:border-primary/50 transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-primary/20">
                      <Icon className="w-6 h-6 md:w-7 md:h-7 text-primary group-hover:rotate-12 transition-transform duration-300" />
                    </div>
                  </div>
                </div>

                <div className="relative z-20 p-6 md:p-8 flex-grow flex flex-col pt-8 md:pt-10">
                  ...
                  <p className="font-inter text-muted-foreground leading-relaxed text-sm md:text-base group-hover:text-foreground/80 transition-colors duration-300 flex-grow">
                    {service.description}
                  </p>
                </div>
              </div>
